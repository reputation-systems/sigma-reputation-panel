...
node_url: str = "http://213.239.193.208:9052/"  # MainNet or TestNet  (el nodo solo puede ser de un tipo)
...
"""
Note how the following parameters are inputted :
...
-------
"""
print(helper_functions.simple_send(
    ergo=ergo,
    amount=amount,
...
assert helper_functions \
           .get_wallet_address(ergo=ergo, amount=1, wallet_mnemonic=wallet_mnemonic)[0] \
       == "3Wx2YrSVcrPvC7uXQRp6ZQfRd7VxjZr6fjhFEX5r1yiM8nHkGv93"
